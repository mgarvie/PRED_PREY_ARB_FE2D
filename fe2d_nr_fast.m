function fe2d_nr_fast ( alpha, beta, gamma, delta, T, delt, u0f, v0f, ...
  k1, k2, g2uf, g2vf )

%*****************************************************************************80
%
%% FE2D_NR_FAST applies Scheme 2 with Kinetics 1 to predator prey in a region.
%
%  Discussion:
%
%    FE2D_NR_FAST is a "fast" version of FE2D_NR.
%
%    FE2D_NR is a finite element Matlab code for Scheme 2 applied 
...
%    as are the list of nodes on which Robin and Neumann boundary
...
%
%  Do the incomplete LU factorization of B1 and B2.
%
...
%
    ...
    rhs_v = v + delt * G;
%
%  Impose Robin boundary conditions on Gamma1.
%
    for i = 1 : e1
      node1 = cpp1(i,1);
      node2 = cpp1(i,2);
