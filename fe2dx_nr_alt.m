function fe2dx_nr_alt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                               Discussion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 'fe2dx_nr_alt.m' is similar to the code 'fe2dx_nr.m', but uses an
% implicit approximation of the Robin boundary condition. The nodes and
% elements of the unstructured grid are loaded from external files
% 't_triang.dat'and 'p_coord.dat' respectively, as are the list of nodes on
% which Robin and Neumann b.c.'s are to be imposed (from 'bn1_nodes.dat'
% and 'bn2_nodes.dat' respectively).
%
% Boundary conditions:
%   Gamma1: Robin
%   Gamma2: Neumann
...
for nt=1:N
    ...
    for i = 1:e1
        ...
        A(node1,node1) = A(node1,node1) - delt*k1*im_hat1*gamma12/2;
        A(node2,node2) = A(node2,node2) - delt*k1*im_hat2*gamma12/2;
        C(node1,node1) = C(node1,node1) - delt*k2*im_hat1*gamma12/2;
        C(node2,node2) = C(node2,node2) - delt*k2*im_hat2*gamma12/2;
    end
