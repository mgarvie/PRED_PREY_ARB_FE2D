function fe2dx_nr_fast ( alpha, beta, gamma, delta, T, delt, u0f, v0f, ...
  k1, k2, g2uf, g2vf )

%*****************************************************************************80
%
%% FE2DX_NR_FAST applies Scheme 1 with Kinetics 1 to predator prey in a region.
%
%  Discussion:
%
%    FE2DX_NR_FAST is a "fast" version of FE2DX_NR.
%
%    FE2DX_NR is a finite element Matlab code for Scheme 1 applied 
