function fe2dx_nd_fast ( alpha, beta, gamma, delta, T, delt, u0f, v0f, ...
  g1uf, g1vf, g2uf, g2vf )

%*****************************************************************************80
%
%% FE2DX_ND_FAST applies Scheme 1 with Kinetics 1 to predator prey in a region.
%
%  Discussion:
%
%    FE2DX_ND_FAST is a "fast" version of FE2DX_ND.
%
%    FE2DX_ND is a finite element Matlab code for Scheme 1 applied 
...
%
%    Input, string G1VF or function pointer @F1VF, a function for the Dirichlet 
...
%
%  Reset matrix entries for Dirichlet boundary conditions on Gamma1.
%
  for i = 1 : isn1
    node = bn1(i);
    C0(node,:)=0; 
...
%
%  Cancel entries that would interfere with Dirichlet conditions.
%
    for i = 1:isn1
      node = bn1(i);
      diag(node) = 0.0; 
...
%
%  Set right hand sides for Dirichlet boundary conditions on Gamma1.
%
    for i = 1 : isn1
      node = bn1(i);
      xx = p(1,node);
