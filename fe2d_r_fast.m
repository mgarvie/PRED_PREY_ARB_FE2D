function fe2d_r_fast ( alpha, beta, gamma, delta, T, delt, u0f, v0f, k1, k2 )

%*****************************************************************************80
%
%% FE2D_R_FAST applies Scheme 2 with Kinetics 1 to predator prey in a region.
%
%  Discussion:
%
%    FE2D_R_FAST is a "fast" version of FE2D_R.
%
%    FE2D_R is a finite element Matlab code for Scheme 2 applied 
...
%
    ...
    rhs_v = v + delt * G;
%
%  Impose Robin boundary conditions on Gamma.
%
    for i = 1 : e
      node1 = edges(i,1);
      node2 = edges(i,2);
